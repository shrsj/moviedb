...
<head>
    ...
    <script src="./js/social_mediaplugs.js" type="text/javascript"></script>
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <!--Live Search -->
     <div class="frmSearch">
        ...
        <a href = 'signuptst.php' id="signup" class="btn" style="float:right;">Sign Up</a>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        echo    "<div class = 'tab'><strong><b>{$row['moviename']} </b></strong><br>".
                                ...
                                "<a href='displaym.php?movid=".$row['movie_id']."'><em> Read</em></a> </div>";
                    }
                }
            mysqli_close($conn); 
        ?>
